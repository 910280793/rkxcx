...
Page({
  ...
  onLoad: function (e) {
    ...
    let that = this;
    console.log("user+" + app.GLOBAL_DATA.USER_INFO.nickName)
    
     
      that.setData({
        headimgUrl: app.GLOBAL_DATA.USER_INFO.avatarUrl,
        nick: app.GLOBAL_DATA.USER_INFO.nickName,
        
      });
    if (app.GLOBAL_DATA.USER_INFO2.testName!=null){
      that.setData({
        subject: app.GLOBAL_DATA.USER_INFO2.testName
      });
